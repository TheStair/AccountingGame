...
export class PauseScene extends Scene {
    ...
    create() {
        ...
        this.resumeText = this.add
            ...
            .setOrigin(0.5)
            .setInteractive();
        this.resumeTextRect = this.add.rectangle(
            this.resumeText.x,
            this.resumeText.y,
            this.resumeText.width,
            this.resumeText.height
        );
    ...
    this.sound.play("selection", { volume: this.game.sfxVolume });
        ...
        this.returnToMainMenu = this.add
            .text(
                (this.scale.width * 3) / 4,
                this.scale.height / 2 +
                    FIRST_RECTANGLE_HEIGHT / 2 +
            ...
            .setOrigin(0.5)
            .setInteractive();
        this.returnToMainMenuRect = this.add.rectangle(
            this.returnToMainMenu.x,
            this.returnToMainMenu.y,
            this.returnToMainMenu.width,
            this.returnToMainMenu.height
        );
