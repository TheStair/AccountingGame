...
export class MenuScene extends Scene {
    ...
    create() {
        ...
        const startGameText = this.add
            ...
            .setOrigin(0.5)
            .setInteractive();
        const startGameTextRect = this.add.rectangle(
            startGameText.x,
            startGameText.y,
            startGameText.width,
            startGameText.height
        );
  ...
  this.sound.play("selection", { volume: this.game.sfxVolume });
        ...
        const startTutorialText = this.add
            .text(
                (this.scale.width * 3) / 4,
                this.scale.height / 2 +
                    FIRST_RECTANGLE_HEIGHT / 2 +
            ...
            .setOrigin(0.5)
            .setInteractive();
        const startTutorialTextRect = this.add.rectangle(
            startTutorialText.x,
            startTutorialText.y,
            startTutorialText.width,
            startTutorialText.height
        );
