...
export class Preloader extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.atlas(
            "up-belt",
            "objects/conveyor-belt/up-belt/up-belt.png",
            "objects/conveyor-belt/up-belt/up-belt_atlas.json"
        );
        this.load.animation(
            "up-belt-anim",
            "objects/conveyor-belt/up-belt/up-belt_anim.json"
        );
        this.load.atlas(
            "down-belt",
            "objects/conveyor-belt/down-belt/down-belt.png",
            "objects/conveyor-belt/down-belt/down-belt_atlas.json"
        );
        this.load.animation(
            "down-belt-anim",
            "objects/conveyor-belt/down-belt/down-belt_anim.json"
        );
        this.load.atlas(
            "right-belt",
            "objects/conveyor-belt/right-belt/right-belt.png",
            "objects/conveyor-belt/right-belt/right-belt_atlas.json"
        );
        this.load.animation(
            "right-belt-anim",
            "objects/conveyor-belt/right-belt/right-belt_anim.json"
        );
        this.load.atlas(
            "left-belt",
            "objects/conveyor-belt/left-belt/left-belt.png",
            "objects/conveyor-belt/left-belt/left-belt_atlas.json"
        );
        this.load.animation(
            "left-belt-anim",
            "objects/conveyor-belt/left-belt/left-belt_anim.json"
        );
